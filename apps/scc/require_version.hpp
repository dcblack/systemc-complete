/******************************************************************************
   ...
   REQUIRES_SC currently recognizes:
...
#if defined(REQUIRES_SC) && defined(SYSTEMC_VERSION)
#  if   (REQUIRES_SC == 240) && (SYSTEMC_VERSION >= 20191203L)
#    define SYSC_VERSION 2.3.4
#  elif (REQUIRES_SC == 234) && (SYSTEMC_VERSION >= 20181013L)
#    define SYSC_VERSION 2.3.4
#  elif (REQUIRES_SC == 233) && (SYSTEMC_VERSION >= 20181013L)
#    define SYSC_VERSION 2.3.3
#  elif (REQUIRES_SC == 232) && (SYSTEMC_VERSION >= 20171012L)
#    define SYSC_VERSION 2.3.2
#  elif (REQUIRES_SC == 231) && (SYSTEMC_VERSION >= 20140417L)
#    define SYSC_VERSION 2.3.1
#  elif (REQUIRES_SC == 230) && (SYSTEMC_VERSION >= 20120701L)
#    define SYSC_VERSION 2.3.0
#  elif (REQUIRES_SC == 220) && (SYSTEMC_VERSION >= 20070314L)
#    define SYSC_VERSION 2.2.0
#  elif (REQUIRES_SC == 211) && (SYSTEMC_VERSION >= 20050714L)
#    define SYSC_VERSION 2.1.1
#  elif (REQUIRES_SC == 201) && (SYSTEMC_VERSION >= 20020405L)
#    define SYSC_VERSION 2.0.1
#  else
#    define SYSC_VERSION "unknown"
#    ifdef WIN32
#      pragma message(SYSTEMC_VERSION # " does not meet minimum requirement of SystemC " # REQUIRES_SC)
#    else
#      if CPP_VERSION >= 2011
       //static_assert( false, #SYSTEMC_VERSION " does not meet minimum requirement of SystemC " #REQUIRES_SC );
#        error SYSTEMC_VERSION does not meet minimum requirement of SystemC REQUIRES_SC
#      else
#        warning SYSTEMC_VERSION does not meet minimum requirement of SystemC REQUIRES_SC
#      endif
#    endif
#  endif
...
#  endif
#  ifdef WIN32
#    pragma message("error REQUIRES_SC not defined")
#  else
#    error REQUIRES_SC not defined
#  endif
#endif
